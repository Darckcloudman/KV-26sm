...
class RD2Parser:
    ...
    def _parse_header(self, header_lines: list):
        ...
        self.metadata['record_number'] = line1[0]  # Первые 5 цифр номера записи
        self.metadata['record_datetime'] = line1[1]  # Дата и время
        ...
        self.metadata['generator_speed'] = f"{line3[1]} RPM"  # Скорость генератора
        self.metadata['active_power'] = f"{line3[4]} KW"  # Активная мощность
